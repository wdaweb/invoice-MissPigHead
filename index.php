<?php
  ...
  // 需要送多個form時 用隱藏欄位 或在submit加name 做區分
?>
<body>
<section id="menu">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown mx-1">
          ...
          <div class="dropdown-menu bg-secondary">
            <a class="dropdown-item text-white" href="./index.php?do=">輸入發票資料</a>
            <!-- 參考寫到iframe的方式  <a href="results/leather1.html" target="imain"> -->
            <div class="dropdown-divider"></div>
            <a class="dropdown-item text-white" href="./index.php?do=">發票列表及操作</a>
            <div class="dropdown-divider"></div>
        ...
        <li class="nav-item dropdown mx-1">
          ...
          <div class="dropdown-menu bg-secondary">
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item text-white" href="./index.php?do=">輸入開獎獎號</a>
          </div>
        </li>
        <li class="nav-item dropdown mx-1">
