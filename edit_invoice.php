...
<form class="container" action="./api/insert_invoice.php" method="post">
  <div class="row justify-content-center">
    ...
    <div class="input-group col-sm-10 col-md-8 col-lg-6 col-xl-5 mx-md-5 px-0 my-2">
      ...
      <select type="number" class="form-control" name="type" value="<?=$inv['type'];?>">
    ...
    <div class="input-group col-sm-10 col-md-8 col-lg-6 col-xl-5 mx-md-5 px-0 my-2">
      ...
      <input type="text" class="form-control" name="store" value="<?=$inv['store'];?>">
    </div>
    <div class="input-group col-sm-10 col-md-8 col-lg-6 col-xl-5 mx-md-5 px-0 my-2">
      <div class="input-group-prepend">
        <span class="input-group-text">其他備註</span>
      </div>
      <input type="text" class="form-control" name="other" value="<?=$inv['other'];?>">
    </div>
