...
for($i=0;$i<10000;$i++){
    ...
    $start_date_timestamp=strtotime('03/01/2019'); // m/d/Y, 設定起始日
    $end_date_timestamp=strtotime('11/15/2020'); // m/d/Y, 設定結束日
    $payment_date=date('Y-m-d',rand($start_date_timestamp,$end_date_timestamp)); // 依上述區間 產出隨機日期
